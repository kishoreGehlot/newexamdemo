...
<div class="page-title-breadcrumb">
	...
	<div class="page-title"><?php echo __('Payment From Paypal');?></div>
    </div>
</div>
<div class="panel">
	...
	<?php echo $this->Form->create('Payment', array('action'=>'checkout','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
		...
		<div class="col-sm-offset-3 col-sm-7">
		    <button type="submit" class="btn btn-success"><span class="fa fa-paypal"></span> <?php echo __('Pay From Paypal');?></button>
		</div>
	    </div>
