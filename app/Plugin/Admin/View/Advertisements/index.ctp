...
<?php echo $this->Session->flash();?>
	...
	<div class="btn-group">
	<?php $url=$this->Html->url(array('controller'=>'Advertisements')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Advertisement'),array('controller'=>'Advertisements','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
         <?php echo $this->Html->link('<span class="fa fa-edit"></span>&nbsp;'.__('Edit'),'javascript:void(0);',array('name'=>'editallfrm','id'=>'editallfrm','onclick'=>"check_perform_edit('$url','advertisements');",'escape'=>false,'class'=>'btn btn-warning'));?>
         <?php echo $this->Html->link('<span class="fa fa-trash"></span>&nbsp;'.__('Delete'),'javascript:void(0);',array('name'=>'deleteallfrm','id'=>'deleteallfrm','onclick'=>"check_perform_delete('advertisements');",'escape'=>false,'class'=>'btn btn-danger'));?>
      </div>
    </div>
...
<div class="table-responsive">
		    ...
		    <li><?php echo $this->Html->link('<span class="fa fa-photo"></span>&nbsp;'.__('Change Photo'),'javascript:void(0);',array('onclick'=>"show_modal('$url/changephoto/$id');",'escape'=>false));?></li>
