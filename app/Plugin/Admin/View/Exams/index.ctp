    ...
    <div class="panel-body">
			    ...
			    <th><?php echo __('Action');?></th>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->Time->format($dtFormat,$post['Exam']['start_date']);?> to <?php echo$this->Time->format($dtFormat,$post['Exam']['end_date']);?></td>
			    ...
			    elseif($post['Exam']['status']=="Closed")echo'<span class="label label-danger">'.__($post['Exam']['status']).'</span>';
                            ...
                            <td><div class="text-left"><?php if($post['Exam']['status']!="Inactive"){echo$this->Html->link('<span class="fa fa-file-excel-o"></span>&nbsp;'.__('Download Result'),array('controller'=>'Downloadresults','action'=>'index',$id),array('class'=>'btn btn-info','escape'=>false));}?></td>
			    ...
			    <li><?php echo $this->Html->link('<span class="fa fa-file-excel-o"></span>&nbsp;'.__('Export Browser Tolrance'),array('action'=>'exporttolrance',$id),array('escape'=>false));?></li>
                             <?php if($post['Exam']['type']=="Exam" && $post['Exam']['status']=="Inactive"){?><li><?php echo$this->Html->link('<span class="fa fa-server"></span>&nbsp;'.__('Questions Attempt Count'),'javascript:void(0);',array('onclick'=>"show_modal('$url/maxquestion/$id');",'escape'=>false));?></li><?php }?>
