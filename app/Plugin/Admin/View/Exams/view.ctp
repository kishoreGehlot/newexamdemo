                    ...
                    <div class="table-responsive"> 
						<table class="table table-bordered">
							...
							<tr>
								...
								<td colspan=2><?php if($post['Exam']['status']=="Active"){echo$this->Form->postLink(__('Close Exam'),array('controller'=>'Attemptedpapers','action'=>'closeexam',$id),array('confirm'=>__('Are you sure, you want to close this exam?'),'class'=>'btn btn-danger'));}
                                                                if($post['Exam']['status']=="Inactive"){echo$this->Html->link(__('Activate Exam'),array('action'=>'activateexam',$id),array('class'=>'btn btn-info'));}
                                                                if($post['Exam']['status']=="Closed"){?><?php echo$this->Form->postLink(__('Exam Closed Re-Activate Exam'),array('action'=>'activateexam',$id),array('confirm'=>__('Are you sure, you want to re-activate this exam?'),'class'=>'btn btn-danger'));}
                                                                ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><strong><small class="text-primary"><?php echo __('Browser Tolerance');?></small></strong></td>
							...
							<tr>
								...
								<td><strong><small class="text-primary">&nbsp;</small></strong></td>
								<td>&nbsp;</td>
					...
					<div class="table-responsive"> 	
						<table class="table table-bordered">
							...
							<tr><td><?php echo$subject_name=h($sd['Subject']['subject_name']);?></td>
								...
								if($diff['Diff']['type']=="D")$hardName=$diff['Diff']['diff_level'];
							...
							<tr>
								...
								<td><strong><?php echo$easyName.' ('.$totalEasy.') '.$mediumName.' ('.$totalMedium.') '.$hardName.' ('.$totalHard.')';?></strong></td>
