...
<?php if(strlen($testId)>0){ echo$this->Form->button('<i class="fa fa-check-circle"></i>&nbsp; '.__('Click here to complete %s',$remExamName),array('onclick'=>"javascript:showpop_up('". $this->Html->url(array('controller' => 'Exams', 'action' => 'start', $testId))."')",'class'=>'btn btn-success','escape'=>false));?><p>&nbsp;</p><?php }?>
<div class="row">
	...
	<div class="panel">		
		...
		<div class="table-responsive">
			...
			<tr>
			    <td><strong><?php echo __('Failed in');?> : </strong><strong class="text-danger"><?php echo$failedExam;?> <?php echo __('Exam');?></strong></td>
			</tr>
			<tr>
			    <td><strong><?php echo __('Average Percentage');?> : </strong><strong class="text-info"><?php echo CakeNumber::toPercentage($averagePercent);?></strong></td>
			</tr>
			<tr>
