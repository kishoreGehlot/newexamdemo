...
<div class="panel">
     <div class="panel-body"><?php echo $this->Session->flash();?>
					...
					$(document).ready(function(){
					    <?php if($post['Content']['is_url']=="External" || $post['Content']['is_url']=="Page"){?>
					    ...
					    $( "#<?php echo$k;?>ContentIsUrlPage" ).click(function() {
					    $('#pgurl<?php echo$k;?>').hide();
					    $('#pgurl1<?php echo$k;?>').show();
					    });
						...
						<div class="panel panel-default">
							...
							<div class="panel-body"><?php echo $this->Session->flash();?>
								<div class="form-group">
								    <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Parent Id');?></small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->select("$k.Content.parent_id",$parentId,array('label' => false,'class'=>'form-control','empty'=>array(0=>__('Root')),'div'=>false));?>
								    </div>								    
								</div>
								<div class="form-group">
									...
									<div class="col-sm-4">
									   <?php echo $this->Form->input("$k.Content.icon",array('type'=>'text','label' => false,'class'=>'form-control','placeholder'=>__('Icon Name'),'div'=>false));?>
									</div>
								</div>
								 <div class="form-group">
								    <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Page Type');?></small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.Content.is_url",array('type'=>'radio','options'=>array("Internal"=>__('Internal'),"Page"=>__('Page'),"External"=>__('External')),'legend'=>false,'before' => '<label class="radio-inline">','separator' => '</label><label class="radio-inline">','after'=>'</label>','label' => false,'div'=>false));?>
								    </div>
								</div>
								 <div class="form-group" id="pgurl1<?php echo$k;?>">
								    <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Url or Page Name');?></small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.Content.url",array('label' => false,'class'=>'form-control','placeholder'=>__('Url or Page Name'),'div'=>false));?>
								    </div>
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.Content.meta_title",array('label' => false,'class'=>'form-control','placeholder'=>__('Meta Title'),'div'=>false));?>
								    </div>
								    <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Meta Keyword');?></small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.Content.meta_keyword",array('label' => false,'class'=>'form-control','placeholder'=>__('Meta Keyword'),'div'=>false));?>
								    </div>
								</div>
								 <div class="form-group">
								    <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Meta Content');?></small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.Content.meta_content",array('label' => false,'class'=>'form-control','placeholder'=>__('Meta Content'),'div'=>false));?>
								    </div>			
								</div>
								</div>
