						...
						<div class="col-md-10"> 
							<div class="table-responsive">
								<table class="table table-striped table-bordered">
									...
									<tr class="text-primary">
										<td><strong><small><?php echo __('Enrolment Number');?>.<strong><small></td>
									...
									<tr class="text-primary"> 
										<td><strong><small><?php echo __('Expiry Days');?><strong><small></td>
										<td><strong><small><?php echo __('Last Login');?><strong><small></td>
										
									</tr>
									<tr>
										<td><small><strong><?php if($post['Student']['expiry_days']==0)echo __('Unlimited');else echo$post['Student']['expiry_days'].' ',__('Days');?></small></strong></td>
										<td><small><strong><?php if($post['Student']['last_login']!=null)echo $this->Time->format($sysDay.$dateSep.$sysMonth.$dateSep.$sysYear.$dateGap.$sysHour.$timeSep.$sysMin.$timeSep.$sysSec.$dateGap.$sysMer,$post['Student']['last_login']); ?></small></strong></td>
