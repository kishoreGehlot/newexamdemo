...
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'News')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New News'),array('controller'=>'News','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
