	...
	<div class="panel-body">
		<div class="table-responsive">
			...
			<tr>
				...
				<td><?php if($post['Exam']['declare_result']=='Yes'){ echo$this->Html->link('<span class="glyphicon glyphicon-fullscreen"></span>&nbsp;',array('action'=>'view',$post['Result']['id']),array('class'=>'btn btn-default','escape'=>false,'data-toggle'=>'tooltip','title'=>__('View Details')));?>
