...
<div class="panel-body">
		...
		<table class="table table-striped">
			...
			<td><?php if($post['Wallet']['in_amount']){echo$currency.$post['Wallet']['in_amount'];}?></td>
			<td><?php if($post['Wallet']['out_amount']){echo$currency.$post['Wallet']['out_amount'];}?></td>
			<td><?php if($post['Wallet']['balance']){echo$currency.$post['Wallet']['balance'];}?></td>
