<?php if($type!="rest"){echo$this->html->link('<span class="fa fa-arrow-left"></span>&nbsp;'.__('Back'),array('action'=>'index'),array('class'=>'btn btn-info','escape'=>false));}
$bookmarkUrl=$this->Html->Url(array('crm'=>true,'controller'=>'Results','action'=>'bookmark',$id));?>
