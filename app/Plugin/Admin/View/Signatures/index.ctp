...
<div class="panel">
    ...
    <div class="panel-body">  <?php echo $this->Session->flash();?>      
	    ...
	    <?php echo$this->Form->button('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Save'),array('class'=>'btn btn-success','escpae'=>false));?>
            <?php echo $this->Html->link('<span class="fa fa-trash"></span>&nbsp;'.__('Delete Signature'),array('controller'=>'Signatures','action'=>'Signaturedel'),array('escape'=>false,'class'=>'btn btn-danger'));?>
            </div>
        </div>
