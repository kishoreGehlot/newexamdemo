...
<?php echo $this->Session->flash();?>
	...
	<div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Students')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Student'),array('controller'=>'Students','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-exchange"></span>&nbsp;'.__('Import/Export Students'),array('controller'=>'Iestudents'),array('escape'=>false,'class'=>'btn btn-default'));?>
            <?php if($frontExamPaid>0){echo $this->Html->link('<span class="fa fa-shopping-cart"></span>&nbsp;'.__('Wallet'),'javascript:void(0);',array('name'=>'walletallfrm','id'=>'walletallfrm','onclick'=>"check_perform_select('$url','wallet');",'escape'=>false,'class'=>'btn btn-info'));
...
<div class="panel-body">
			    ...
			    <li><?php echo $this->Html->link('<span class="fa fa-arrows-alt"></span>&nbsp;'.__('View'),'javascript:void(0);',array('onclick'=>"show_modal('$url/View/$id');",'escape'=>false));?></li>
                            <li><?php if($frontExamPaid>0){echo $this->Html->link('<span class="fa fa-shopping-cart"></span>&nbsp;'.__('Wallet'),'javascript:void(0);',array('name'=>'walletallfrm','onclick'=>"show_modal('$url/wallet/$id');",'escape'=>false));}?></li>
