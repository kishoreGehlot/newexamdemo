<div <?php if(!$isError){?>class="container"<?php }?>>    
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Exam');?><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div>
                        ...
                        <div class="panel-body"><?php echo $this->Session->flash();?>
							   ...
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<label for="group_name" class="col-sm-2 control-label"><?php echo __('Browser Tolerance');?></label>
									<div class="col-sm-4">
