...
<?php echo $this->Session->flash();?>
	...
	<div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Subjects')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Subject'),array('controller'=>'Subjects','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
